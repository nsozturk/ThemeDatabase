...
const EN_MESSAGES: Record<string, string> = {
  ...
  'builder.group.scrollbar': 'Scrollbar Markers',
  'builder.group.markup': 'Markup Text',
  'builder.fontConfig': 'Font Configuration',
  'builder.fontFamily': 'Font Family',
  'builder.fontSize': 'Font Size',
  ...
  'export.field.attribute': 'Attribute',
  'export.field.character': 'Character',
  'export.field.preprocessor': 'Preprocessor',
  'export.field.url': 'URL',
  'export.field.mark': 'Mark / MARK',
  'export.field.class': 'Class',
  'export.field.classSystem': 'Class (System)',
  'export.field.constant': 'Constant',
  'export.field.constantSystem': 'Constant (System)',
  'export.field.macro': 'Macro',
  'export.field.macroSystem': 'Macro (System)',
  'export.field.declarationType': 'Declaration (Type)',
  'export.field.declarationOther': 'Declaration (Other)',
  'export.field.regex': 'Regular Expression',
  'export.field.regexKeyword': 'Regex Keyword',
  'export.field.regexCaptureVar': 'Regex Capture Variable',
  'export.field.regexCharClass': 'Regex Character Class',
  'export.field.regexNumber': 'Regex Number',
  'export.field.regexConstant': 'Regex Constant',
  'export.field.consoleText': 'Console Text',
  'export.field.consoleBackground': 'Console Background',
  'export.field.consoleCaret': 'Console Cursor',
  'export.field.consoleSelection': 'Console Selection',
  'export.field.debugConsoleText': 'Debug Console Text',
  'export.field.consoleExecutable': 'Console Executable Output',
  'export.field.consoleInput': 'Console Input',
  'export.field.consoleForeground': 'Console Foreground',
  'export.field.scrollBreakpoint': 'Scrollbar: Breakpoint',
  'export.field.scrollDiff': 'Scrollbar: Diff',
  'export.field.scrollDiffConflict': 'Scrollbar: Diff Conflict',
  'export.field.scrollError': 'Scrollbar: Error',
  'export.field.scrollFindResult': 'Scrollbar: Find Result',
  'export.field.scrollInstructionPtr': 'Scrollbar: Instruction Pointer',
  'export.field.scrollWarning': 'Scrollbar: Warning',
  'export.field.markupNormal': 'Markup: Normal',
  'export.field.markupOtherHeading': 'Markup: Other Heading',
  'export.field.markupPrimaryHeading': 'Markup: Primary Heading',
  'export.field.markupSecondaryHeading': 'Markup: Secondary Heading',
  'export.field.markupStrong': 'Markup: Strong',
  'export.field.markupEmphasis': 'Markup: Emphasis',
  'export.field.markupCode': 'Markup: Code',
  'export.field.markupLink': 'Markup: Link',
...
const MESSAGES: Record<Locale, Record<string, string>> = {
  ...
  tr: {
    ...
    'builder.themeOrPayloadNotFound': 'Tema veya payload bulunamadı.',
	    ...
	    'builder.group.scrollbar': 'Kaydırma Çubuğu İşaretçileri',
	    'builder.group.markup': 'Markup Metin',
	    'builder.fontConfig': 'Font Ayarları',
	    'builder.fontFamily': 'Font Ailesi',
	    'builder.fontSize': 'Font Boyutu',
